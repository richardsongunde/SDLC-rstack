...
- Are SQL safety, LLM trust boundary, and auth issues explicitly checked?
- Does every finding include a specific file and line reference?
- Is the verdict clearly APPROVE or CHANGES REQUESTED?
...
Read `.rstack/skills/review/checklist.md`.
...
```bash
~/.rstack/bin/rstack-review-log '{"skill":"review","timestamp":"TIMESTAMP","status":"STATUS","issues_found":N,"critical":N,"informational":N,"commit":"COMMIT"}'
```
...
```bash
~/.rstack/bin/rstack-learnings-log '{"skill":"review","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
