...
If yes, log it:
```bash
rstack memory append '{"skill":"powershell-security-hardening","type":"operational","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":8,"source":"observed"}' 2>/dev/null || true
```
