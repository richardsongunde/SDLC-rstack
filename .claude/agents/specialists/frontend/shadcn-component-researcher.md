...
description: |
  Specialist agent for shadcn component researcher tasks and workflows. Trigger:
  any request involving shadcn component researcher. (frontend)
model: sonnet
tools:
  - Bash
  - Read
...
If yes, log it:
```bash
~/.claude/bin/rstack-learnings-log '{"skill":"shadcn-component-researcher","type":"operational","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":8,"source":"observed"}' 2>/dev/null || true
```
