...
name: docker-expert
description: |
  Docker multi-stage builds, image optimization, and docker-compose orchestration.
  Trigger: "write a Dockerfile", "optimize this Docker image", "set up
...
If yes, log it:
```bash
~/.claude/bin/rstack-learnings-log '{"skill":"docker-expert","type":"operational","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":8,"source":"observed"}' 2>/dev/null || true
```
