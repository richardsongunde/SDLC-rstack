---
name: performance-monitor-devops
description: |
  Specialist agent for performance monitor tasks and workflows. Trigger: any
  request involving performance monitor. (devops)
model: sonnet
tools:
  - Bash
  - Read
...
If yes, log it:
```bash
~/.claude/bin/rstack-learnings-log '{"skill":"performance-monitor","type":"operational","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":8,"source":"observed"}' 2>/dev/null || true
```
