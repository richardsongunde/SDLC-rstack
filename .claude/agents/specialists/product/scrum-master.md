...
name: scrum-master
description: |
  Sprint facilitation, impediment removal, and agile process improvement. Trigger:
  "run the sprint planning/retrospective", "remove this blocker", "improve our
  sprint velocity". (product)
model: sonnet
tools:
  - Read
  - Write
...
If yes, log it:
```bash
~/.claude/bin/rstack-learnings-log '{"skill":"scrum-master","type":"operational","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":8,"source":"observed"}' 2>/dev/null || true
```
