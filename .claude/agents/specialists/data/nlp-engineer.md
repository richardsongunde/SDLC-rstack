...
name: nlp-engineer
description: |
  Specialist agent for nlp engineer tasks and workflows. Trigger: any request
  involving nlp engineer. (data)
model: sonnet
tools:
  - Bash
  - Read
...
If yes, log it:
```bash
~/.claude/bin/rstack-learnings-log '{"skill":"nlp-engineer","type":"operational","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":8,"source":"observed"}' 2>/dev/null || true
```
