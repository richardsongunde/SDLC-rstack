...
description: |
  Specialist agent for machine learning engineer tasks and workflows. Trigger: any
  request involving machine learning engineer. (data)
model: sonnet
tools:
  - Bash
  - Read
...
If yes, log it:
```bash
~/.claude/bin/rstack-learnings-log '{"skill":"machine-learning-engineer","type":"operational","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":8,"source":"observed"}' 2>/dev/null || true
```
