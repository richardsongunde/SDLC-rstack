...
name: mlops-engineer
description: |
  Specialist agent for mlops engineer tasks and workflows. Trigger: any request
  involving mlops engineer. (data)
model: sonnet
tools:
  - Bash
  - Read
...
If yes, log it:
```bash
~/.claude/bin/rstack-learnings-log '{"skill":"mlops-engineer","type":"operational","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":8,"source":"observed"}' 2>/dev/null || true
```
