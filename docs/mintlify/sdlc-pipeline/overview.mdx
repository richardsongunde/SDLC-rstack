...
description: "The 14-agent SDLC pipeline from environment discovery to cost estimation."
---

## The complete pipeline

RStack ships 14 SDLC pipeline agents that cover the full software delivery lifecycle:
